...
//============================================================================================================
class ChaosGamePluginClass : public IVisPlugin_cl
{
public:
  ...
  {
    return "ChaosGamePlugin";  // must match DLL name
  }
};

//  global plugin instance
ChaosGamePluginClass g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_ChaosGamePlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_ChaosGamePlugin();}
...
void ChaosGamePluginClass::OnInitEnginePlugin()
{
  hkvLog::Info("ChaosGamePluginClass:OnInitEnginePlugin()");
...
// load plugins if supported
  ...
  FORCE_LINKDYNCLASS( mBaseComponent );
  // [...]

  // Start our component managers and game manager here....
  MyGameManager::GlobalManager().OneTimeInit();
  mBaseComponent_ComponentManager::GlobalManager().OneTimeInit();
  // [...]
...
void ChaosGamePluginClass::OnDeInitEnginePlugin()
{
  hkvLog::Info("ChaosGamePluginClass:OnDeInitEnginePlugin()");
    
  // Close our component managers here....
  mBaseComponent_ComponentManager::GlobalManager().OneTimeDeInit();
