...
#include "ChaosGameApplicationPCH.h"
...
VIMPORT IVisPlugin_cl* GetEnginePlugin_ChaosGamePlugin();


class ChaosGameApplicationClass : public VAppImpl
{
public:
  ChaosGameApplicationClass() {}
  virtual ~ChaosGameApplicationClass() {}
...
VAPP_IMPLEMENT_SAMPLE(ChaosGameApplicationClass);

void ChaosGameApplicationClass::SetupAppConfig(VisAppConfig_cl& config)
{
  ...
  config.m_videoConfig.m_szWindowTitle = "ChaosGame";
...
void ChaosGameApplicationClass::PreloadPlugins()
{
...
//---------------------------------------------------------------------------------------------------------
void ChaosGameApplicationClass::AfterSceneLoaded(bool bLoadingSuccessful)
{
...
//---------------------------------------------------------------------------------------------------------
bool ChaosGameApplicationClass::Run()
{
  return true;
}

void ChaosGameApplicationClass::DeInit()
{
  // De-Initialization
  // [...]
}
